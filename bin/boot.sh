...
exec $APP_ROOT/oauth2_proxy/oauth2_proxy --config="$APP_ROOT/oauth2_proxy/oauth2_proxy.cfg" --github-org="$GITHUB_ORG" --http-address="http://:$PORT" --upstream="http://127.0.0.1:$APPLICATION_PORT" --email-domain="*"
